...
RUN apt-get update && apt-get install -y git libgnutls-dev lua5.1 liblua5.1-0 liblua5.1-0-dev screen python-dev python-pip bzip2 zlib1g-dev build-essential automake curl flex unzip && rm -rf /var/lib/apt/lists/*
